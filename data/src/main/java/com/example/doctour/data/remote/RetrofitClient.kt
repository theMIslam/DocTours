...
import com.example.doctour.data.remote.NetworkFastBuilder.Companion.provideOkHttpClientBuilder
import com.example.doctour.data.remote.NetworkFastBuilder.Companion.provideRetrofit
...
import com.example.doctour.data.remote.interceptor.AuthenticationInterceptor
...
class NetworkClient @Inject constructor(
    ...
    fun generateDoctorsApiService() = retrofit.createAnApi<DoctorsApiService>()
